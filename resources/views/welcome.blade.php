...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="mt-5 card" >
            ...
            <div class="card-body">
                <input type="text" class="form-control w-50 mx-auto" id="textbox" />
               <div class="text-center my-5">
                   <span class="mx-5">User is  Typing ...</span>
        ...
        <div id="message-box">
            ...
            <div class="alert alert-secondary w-50" role="alert">
                <strong>saimarnpha@gmail.com</strong> <br/>
